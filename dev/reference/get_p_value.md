...
- x:
  ...
  [`calculate()`](https://infer.tidymodels.org/dev/reference/calculate.md)d
  statistics or
  [`fit()`](https://infer.tidymodels.org/dev/reference/fit.infer.md)ted
  ...
  to [`fit()`](https://infer.tidymodels.org/dev/reference/fit.infer.md).
  For theory-based inference, the output of
...
- obs_stat:
  ...
  [`calculate()`](https://infer.tidymodels.org/dev/reference/calculate.md)
  or [`fit()`](https://infer.tidymodels.org/dev/reference/fit.infer.md)
  and need not to have been passed to
  [`generate()`](https://infer.tidymodels.org/dev/reference/generate.md).
...
- `term`: The explanatory variable (or intercept) in question. Only
  ...
  [`fit()`](https://infer.tidymodels.org/dev/reference/fit.infer.md).
...
hypothesis, and only a small number of `reps` have been generated to
form a null distribution, it is possible that the observed statistic
will be more extreme than every test statistic generated to form the
null distribution, resulting in an approximate p-value of 0. In this
case, the true p-value is a small value likely less than `3/reps` (based
on a poisson approximation).
